...
{
    public class SilverStreetSMSMessageSender : IMessageSender
    {
        public string SendMessage(ISMSMessage m)
        {
            ...
            data.Add("body", HttpUtility.UrlEncode(message.Body));
        ...
        public SilverStreetSMSMessageSender(IPhoneNumberFormatter formatter)
        {
